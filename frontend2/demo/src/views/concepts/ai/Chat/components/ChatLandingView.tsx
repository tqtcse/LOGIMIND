...
const promptSuggestion: {
    ...
    type: PromptType
        ...
        {
            title: 'Hãy cho tui thông tin liên quan để hướng dẫn cách tra cứu mã hscode',
        ...
        // {
        //     title: 'Mẫu câu mà tui nên hỏi như nào để tăng độ chính xác khi hỏi',
        ...
        // },
        {
            title: 'Định dạng câu hỏi mà tui nên hỏi như nào để tăng độ chính xác khi hỏi',
        ...
        <div className="max-w-[900px] w-full mx-auto mt-20 ">
            <div>
                <div className="heading-text text-4xl leading-snug">
                    ...
                    <br />
                    <span>Tôi có thể giúp gì bạn cho hôm nay?</span>
                </div>
                <div className="mt-8 grid grid-cols-2 xl:grid-cols-4 gap-4 xl:pl-30 ">
