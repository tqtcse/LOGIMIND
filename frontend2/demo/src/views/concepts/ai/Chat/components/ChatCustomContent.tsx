...
const markedOptions = {
    gfm: false, // Tắt chế độ GitHub-Flavored Markdown để tránh khoảng cách không mong muốn
    breaks: true, // Giữ nguyên xuống dòng
  };

  
  const ChatCustomContent = ({ content = '', triggerTyping, onFinish }: ChatCustomContentProps) => {
    const finalContent = (
        <div className="markdown-content">
            {ReactHtmlParser(marked.parse(content, { async: false }))}
        </div>
    );
